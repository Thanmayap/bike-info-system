...
r.post('/send-otp', (req, res, next) => require('../controllers/authController').sendOtp(req, res, next));
r.post('/login-otp', (req, res, next) => require('../controllers/authController').loginWithOtp(req, res, next));
